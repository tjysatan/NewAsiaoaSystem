...
namespace NewAsiaOASystem.DBModel
{
    ...
    public class DKX_DDinfo
    {
        ...
        /// <summary>
        /// 订单状态 -1 未提交 0已提交 1 待制图 2 制图中 （-1 未提交 0已提交 1 待制图 2 制图中  -2 待审核 3 待生产） 3 待生产 4生产中 5 缺料 6 待发货 7 完成  ( 4 可生产  5 缺料 6 生产中 -3 待品审 7 待发货 8 完成 )
        /// </summary>
