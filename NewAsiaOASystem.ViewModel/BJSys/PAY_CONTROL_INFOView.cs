...
{
    public class PAY_CONTROL_INFOView
    {
        ...
        public virtual int? HEATING_OIL_ROUTES { get; set; }

        public virtual decimal? FLAG_JX { get; set; }

        public virtual decimal? FLAG_LIGHT { get; set; }


        public virtual decimal? bjPrice { get; set; }

        /// <summary>
        /// 报价单类型 0 其他  1 医药库
        /// </summary>
        public virtual string bjdtype { get; set; }
