...
namespace NewAsiaOASystem.ViewModel
{
    ...
    public class SysRoleView
    {
        ...
        /// 授权代码
        /// </summary>
        public virtual string SysAuth { get; set; }

        /// <summary>
        /// 功能权限
        /// </summary>
        public virtual string SysFun { get; set; }

        /// <summary>
        /// 字段
        /// </summary>
       public virtual string SysField { get; set; }

        /// <summary>
        /// 角色对应用户
        /// </summary>
        public virtual string SysPerson { get; set; }

        /// <summary>
        /// 角色对应部门
        /// </summary>
        public virtual string SysDept { get; set; }
