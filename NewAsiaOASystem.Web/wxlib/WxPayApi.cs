...
namespace NewAsiaOASystem.Web
{
    public class WxPayApi
    {
         ...
         */
        public static WxPayData Micropay(WxPayData inputObj,NewConfig config, int timeOut = 10)
        {
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj,NewConfig config, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj,NewConfig config, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Refund(WxPayData inputObj,NewConfig config, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData RefundQuery(WxPayData inputObj,NewConfig config, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData ShortUrl(WxPayData inputObj,NewConfig config, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, NewConfig config, int timeOut = 6)
        {
            ...
            //签名
            inputObj.SetValue("sign", inputObj.NewMakeSign(config.KEY));
            string xml = inputObj.ToXml();
            var start = DateTime.Now;
            string response = HttpService.Post(xml, url, false, timeOut);
            var end = DateTime.Now;
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData CloseOrder(WxPayData inputObj,NewConfig config, int timeOut = 6)
        {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj,NewConfig config)
        {
            //如果不需要进行上报
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj,NewConfig config, int timeOut = 1)
        {
        ...
        */
        ...
        public static string NewGenerateOutTradeNo(string MCHID)
        {
            var ran = new Random();
