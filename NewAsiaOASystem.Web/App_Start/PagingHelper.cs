...
namespace DiseaseControl.Web
{
    public class PagingHelper<T>
    {
        ...
        #region 构造函数,设置分页数据集  PagingHelper(string pageIndex, int PageSum, IEnumerable<T> dataSource)
        ...
        public PagingHelper(int pageIndex, int PageSum, IEnumerable<T> dataSource)
        {
            //从配置文件获取分页条数
